...
# Row 2
	Point.new(Vector2(col1,107),[0,7,62,-1]),
	Point.new(Vector2(col3,107),[1,8,54,6]),
	Point.new(Vector2(col4,107),[-1,9,55,7]),
	Point.new(Vector2(col5,107),[2,10,-1,8]),
	Point.new(Vector2(col6,107),[3,11,-1,9]),
	Point.new(Vector2(col7,107),[-1,12,58,10]),
	Point.new(Vector2(col8,107),[4,13,59,11]),
	Point.new(Vector2(col10,107),[5,-1,65,12]),
# Row 3
...
# Row 7
	Point.new(Vector2(col1,293),[-1,35,62,-1]),
	Point.new(Vector2(col3,293),[27,36,54,34]),
	Point.new(Vector2(col4,293),[32,37,-1,35]),
	Point.new(Vector2(col5,293),[-1,-1,63,36]),
	Point.new(Vector2(col6,293),[-1,39,64,-1]),
	Point.new(Vector2(col7,293),[33,40,-1,38]),
	Point.new(Vector2(col8,293),[30,41,59,39]),
	Point.new(Vector2(col10,293),[-1,-1,65,40]),
# Row 8
	Point.new(Vector2(col1,330),[34,43,-1,-1]),
	Point.new(Vector2(col2,330),[-1,-1,53,42]),
	Point.new(Vector2(col3,330),[35,45,54,-1]),
	Point.new(Vector2(col4,330),[-1,46,55,44]),
	Point.new(Vector2(col5,330),[37,47,-1,45]),
	Point.new(Vector2(col6,330),[38,48,-1,46]),
	Point.new(Vector2(col7,330),[-1,49,58,47]),
	Point.new(Vector2(col8,330),[40,-1,59,48]),
	Point.new(Vector2(col9,330),[-1,51,60,-1]),
	Point.new(Vector2(col10,330),[41,-1,-1,50]),
# Row 9
	...
	Point.new(Vector2(col10,363),[-1,-1,65,60]),
# Row 10
